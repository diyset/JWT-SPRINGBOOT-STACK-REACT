package com.diansetiyadi.backend.service;

import com.diansetiyadi.backend.exception.BadRequestException;
import com.diansetiyadi.backend.exception.ResourceNotFoundException;
import com.diansetiyadi.backend.model.*;
...
import com.diansetiyadi.backend.util.ModelMapper;
...
public class PollService {
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        Map<Long, Long> choicesVotesMap = votes.stream().collect(Collectors.toMap(ChoiceVoteCount::getChoiceId, ChoiceVoteCount::getVoteCount));
    ...
    public PollResponse castVoteAndGetUpdatePoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        try {
            ...
            logger.info("User {} has already vote in Poll {}",currentUser.getId(), pollId);
